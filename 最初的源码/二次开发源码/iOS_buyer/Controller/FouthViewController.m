...
-(void)viewWillLayoutSubviews
{
    ...
    if (self.brandNav==YES) {
        ...
        MyTableView.frame = CGRectMake(20, 64, self.view.bounds.size.width-25,self.view.bounds.size.height-64);
...
-(void)netWork{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",FIRST_URL,BRANDMY_URL]];
