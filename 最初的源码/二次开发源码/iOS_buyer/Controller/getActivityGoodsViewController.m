...
//    LoadingView.hidden = NO;
    ...
    NSArray *keyArr = [[NSArray alloc]initWithObjects:@"actId",@"pageNum", nil];
    NSArray *valueArr = [[NSArray alloc]initWithObjects:classifyModel.goods_id,@"1", nil];
...
-(void)netWorkingUp:(NSString *)pageNum_net{
    NSArray *keyArr = [[NSArray alloc]initWithObjects:@"actId",@"pageNum", nil];
    NSArray *valueArr = [[NSArray alloc]initWithObjects:classifyModel.goods_id,pageNum_net, nil];
