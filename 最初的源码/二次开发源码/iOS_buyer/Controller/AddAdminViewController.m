...
-(void)viewWillAppear:(BOOL)animated{
    ...
    requestAdmin1 = [ASIFormDataRequest requestWithURL:url];
    [requestAdmin1 setPostValue:[fileContent2 objectAtIndex:3] forKey:@"user_id"];
    [requestAdmin1 setPostValue:[fileContent2 objectAtIndex:1] forKey:@"token"];
    [requestAdmin1 setRequestHeaders:[LJControl requestHeaderDictionary]];
    requestAdmin1.tag = 101;
    [requestAdmin1 setDelegate: self];
    [requestAdmin1 setDidFailSelector:@selector(urlRequestFailed:)];
    [requestAdmin1 setDidFinishSelector:@selector(urlRequestSucceeded:)];
    [requestAdmin1 startAsynchronous];
}
...
-(void)writeMessage:(UIButton *)btn{
    ...
    sy.infoArrayWhenEditing = @[class.manager_addr_id,class.manager_area,class.manager_areaInfo,class.manager_telephone,class.manager_trueName,class.manager_zip];
    [self.navigationController pushViewController:sy animated:YES];
}
-(void)backBtnClicked{
    if (_cloudCartModel) {
