...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.row == 0) {
        return ScreenFrame.size.width + 360+8;
    }
    if (indexPath.row == 1) {
        return 60;
    }
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        ...
        UIView *backView=[LJControl viewFrame:CGRectMake(0, line2.bottom, ScreenFrame.size.width, 80) backgroundColor:UIColorFromRGB(0xf8f8f8)];
        ...
        UIView *line4=[LJControl viewFrame:CGRectMake(0, label2.bottom, ScreenFrame.size.width, 0.5) backgroundColor:UIColorFromRGB(0xd7d7d7)];
...
//        [cell addSubview:lblLine2];
        ...
        // 运费
        UILabel *label8 = [[UILabel alloc]initWithFrame:CGRectMake(15, line7.bottom, 120, 40)];
        label8.text = @"运费:";
        ...
        // 运费数字
        self.lblTransfee = [[UILabel alloc]initWithFrame:CGRectMake(98, line7.bottom, 120, 40)];
