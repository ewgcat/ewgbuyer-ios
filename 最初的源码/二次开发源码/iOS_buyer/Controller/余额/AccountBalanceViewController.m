...
-(void)designPage{
    ...
    UIView *bView=[LJControl viewFrame:CGRectMake(0, 64,ScreenFrame.size.width, 250) backgroundColor:UIColorFromRGB(0Xf16a26)];
    ...
    ccLabel=[LJControl labelFrame:CGRectMake(0, 150, bView.bounds.size.width, 50) setText:@"0.00"setTitleFont:22 setbackgroundColor:[UIColor clearColor] setTextColor:UIColorFromRGB(0Xffffff) textAlignment:NSTextAlignmentCenter];
    [bView addSubview:ccLabel];
    
    UILabel *apLabel=[LJControl labelFrame:CGRectMake(10, bView.bounds.size.height+64, ScreenFrame.size.width-20, 55) setText:@"提示：买家会员可以用来支付订单、提现，商家可以用来支付商城收费服务。" setTitleFont:17 setbackgroundColor:[UIColor clearColor] setTextColor:UIColorFromRGB(0X7c7e81) textAlignment:NSTextAlignmentLeft];
    apLabel.numberOfLines=3;
    [self.view addSubview:apLabel];
    
    UIButton *withdrawButton=[LJControl buttonType:UIButtonTypeCustom setFrame:CGRectMake(ScreenFrame.size.width/4-70,ScreenFrame.size.height-60,90,40) setNormalImage:nil setSelectedImage:nil setTitle:nil setTitleFont:0 setbackgroundColor:nil];
    ...
    UIButton * cardButton=[LJControl buttonType:UIButtonTypeCustom setFrame:CGRectMake(ScreenFrame.size.width/4*3-20,ScreenFrame.size.height-60,90,40) setNormalImage:nil setSelectedImage:nil setTitle:nil setTitleFont:0 setbackgroundColor:nil];
    cardButton.tag=1003;
    ...
    UIButton * moneyButton=[LJControl buttonType:UIButtonTypeCustom setFrame:CGRectMake(ScreenFrame.size.width/4*2-45,ScreenFrame.size.height-60,90,40) setNormalImage:nil setSelectedImage:nil setTitle:nil setTitleFont:0 setbackgroundColor:nil];
