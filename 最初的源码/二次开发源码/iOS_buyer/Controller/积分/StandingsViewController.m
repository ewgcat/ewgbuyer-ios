...
//    [view1 addSubview:label3];
    ...
    UILabel *label4=[LJControl labelFrame:CGRectMake(0,0,80, 30) setText:@"兑换记录" setTitleFont:13 setbackgroundColor:[UIColor whiteColor] setTextColor:UIColorFromRGB(0Xe1a4a6) textAlignment:NSTextAlignmentCenter];
    button1.tag=1001;
