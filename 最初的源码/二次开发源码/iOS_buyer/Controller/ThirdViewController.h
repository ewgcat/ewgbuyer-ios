...
@interface ThirdViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,ASIHTTPRequestDelegate,UITextFieldDelegate,CHSectionSelectionViewDelegate>{
    UIView *logView;
...
@property(assign,nonatomic)BOOL ticBOOL;
@property(strong,nonatomic)NSDictionary *ticdic;
...
@property(strong,nonatomic)NSString *usecoupons_id;
