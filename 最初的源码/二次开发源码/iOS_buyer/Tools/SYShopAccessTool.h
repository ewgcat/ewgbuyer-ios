...
+(void)checkPassword:(NSString *)password orderID:(NSString *)orderID ofBalancePay:(void(^)(BOOL valid))success failure:(void(^)(NSString *errStr))failure;//订单预存款支付\支付密码验证
