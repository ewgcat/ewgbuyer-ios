...
+(instancetype)myAttentionView{
    return [FirstIndexxCell getMyViewWithImageLocal:@"first_0" title:@"我的关注" idx:0];
}
+(instancetype)logisticsView{
    return [FirstIndexxCell getMyViewWithImageLocal:@"first_1" title:@"物流查询" idx:1];
}
+(instancetype)cloudPurchaseView{
    return [FirstIndexxCell getMyViewWithImageLocal:@"first_2" title:@"云购" idx:2];
}
+(instancetype)brandView{
    return [FirstIndexxCell getMyViewWithImageLocal:@"brandNew" title:@"品牌" idx:2];
}
+(instancetype)ticketView{
    return [FirstIndexxCell getMyViewWithImageLocal:@"first_3" title:@"免费抢券" idx:3];
}
+(instancetype)saleView{
    return [FirstIndexxCell getMyViewWithImageLocal:@"first_4" title:@"促销" idx:4];
}
+(instancetype)groupPurchaseView{
    return [FirstIndexxCell getMyViewWithImageLocal:@"first_5" title:@"团购" idx:5];
}
+(instancetype)couponView{
    return [FirstIndexxCell getMyViewWithImageLocal:@"first_6" title:@"积分商城" idx:6];
}
+(instancetype)freeView{
    return [FirstIndexxCell getMyViewWithImageLocal:@"first_7" title:@"0元试用" idx:7];
}
