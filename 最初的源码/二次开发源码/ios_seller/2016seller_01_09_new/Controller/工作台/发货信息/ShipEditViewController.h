...
@interface ShipEditViewController : UIViewController<UITextFieldDelegate,UITextViewDelegate,UITableViewDelegate,UITableViewDataSource>{
...
@property (retain, nonatomic) UILabel *lblCity;
