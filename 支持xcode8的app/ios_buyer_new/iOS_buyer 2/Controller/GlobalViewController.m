...
@interface GlobalViewController ()<UIWebViewDelegate>
{
    UIWebView *webview;
...
-(void)loadPage{
    NSString *url=[NSString stringWithFormat:@"%@/app/topics_2.htm?device_type=iOS",FIRST_URL];
