//
//  SubTeamTableViewController.m
//  My_App
//
//  Created by 邱炯辉 on 16/6/22.
...
@interface SubTeamTableViewController ()
{
    int _start;
...
@implementation SubTeamTableViewController
...
-(void)getData{
    ...
    [[Requester managerWithHeader]POST:urlStr parameters:par success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        label2.text=[NSString stringWithFormat:@"激情e+"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ThirdSubTableViewController *vc=[[ThirdSubTableViewController alloc]init];
