...
@property (retain, nonatomic) UITextField *surePWField;//确认密码
@property (retain, nonatomic) UITextField *invitecodeTf;//邀请码tf


@property (assign, nonatomic) BOOL isScanRegister;//扫码注册
