...
//    [self.imgAddBG addSubview:self.lblTitleMes];
   ...
   [self.imgAddBG addSubview:redLab];
    ...
    UIImageView *imgAccountsBG = [[UIImageView alloc]initWithFrame:CGRectMake(0, 170, ScreenFrame.size.width, 60)];
    ...
    btnSubmit.center = CGPointMake(ScreenFrame.size.width/2, 315);
    ...
    if (statuscode2 == 200) {
        ...
        if (code.intValue == 100) {
            ...
            if (code.intValue == 100) {
                ...
                third.jie_order_goods_price = [NSString stringWithFormat:@"%@",ex.lblAllShipfee.text];
