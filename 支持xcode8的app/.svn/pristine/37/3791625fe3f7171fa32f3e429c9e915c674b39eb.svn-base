...
- (void)initControlBtn {
    UIView *bgview=[LJControl viewFrame:CGRectMake(0, self.view.frame.size.height - 50.0f, self.view.frame.size.width, 50) backgroundColor:[UIColor whiteColor]];
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0,0, 100, 50)];
    cancelBtn.backgroundColor = [UIColor clearColor];
    UILabel *cancellabel=[LJControl labelFrame:CGRectMake(0, 0, 100, 50) setText:@"取消" setTitleFont:18 setbackgroundColor:[UIColor clearColor] setTextColor:[UIColor lightGrayColor] textAlignment:NSTextAlignmentCenter];
    ...
    UILabel *confirmlabel=[LJControl labelFrame:CGRectMake(0, 0, 100, 50) setText:@"确定" setTitleFont:18 setbackgroundColor:[UIColor clearColor] setTextColor:[UIColor lightGrayColor] textAlignment:NSTextAlignmentCenter];
