...
//        req.openID=@"12c3a33dd1767d889ac031d5a93cd563";
        WXApiManager *amanager=[WXApiManager sharedManager];
        amanager.delegate=self;
...
#pragma mark -自动登录
-(void)autologin:(NSNotification *)sender{
    [SYObject startLoading];
  NSDictionary *userInfo=  sender.userInfo;
    
    self.userNameField.text=userInfo[@"phone"];
    self.userPasswordField.text=userInfo[@"password"];
