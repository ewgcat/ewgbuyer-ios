...
- (void)viewDidLoad {
    ...
    [self getBuyerPredepositLogUserId:[SYObject currentUserID] andBeginCount:@"0" andSelectCount:@"10"  andToken:[SYObject currentToken] andDepositType:@""];
...
-(void)createNavigation{
    ...
    rightlabel=[LJControl labelFrame:CGRectMake(0, 0, 104, 40) setText:@"全部" setTitleFont:17 setbackgroundColor:[UIColor clearColor] setTextColor:[UIColor whiteColor] textAlignment:NSTextAlignmentRight];
    [rightButton addSubview:rightlabel];
    
    UIImageView *rightimage=[LJControl imageViewFrame:CGRectMake(104, 24, 10, 10) setImage:@"whitedownarrow.png" setbackgroundColor:[UIColor clearColor]];
